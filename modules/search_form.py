...
class SearchFormManager(IsogeoDockWidget):
    ...
    def init_steps(self):
        ...
        """
        # self.tbl_result.horizontalHeader().setSectionResizeMode(0, 2)
        # self.tbl_result.horizontalHeader().setSectionResizeMode(1, 2)
        # self.tbl_result.horizontalHeader().setSectionResizeMode(2, 2)
        # self.tbl_result.horizontalHeader().setSectionResizeMode(3, 1)
