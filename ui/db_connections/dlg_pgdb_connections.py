...
FORM_CLASS, _ = uic.loadUiType(os.path.join(os.path.dirname(__file__), "ui_pgdb_connections.ui"))

# from ui_pgdb_connections import Ui_dlg_pgdb_connections


# # changed besause of an issue generated by Qt Designer
# # see: http://gis.stackexchange.com/a/155599/19817
# class Isogeodb_connections(QDialog, FORM_CLASS):
...
class Isogeodb_connections(QDialog, FORM_CLASS):
    ...
    def __init__(self, parent=None):
        """Constructor."""
        super(Isogeodb_connections, self).__init__(parent)
