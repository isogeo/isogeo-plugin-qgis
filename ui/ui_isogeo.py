...
class Ui_IsogeoDockWidgetBase(object):
    def setupUi(self, IsogeoDockWidgetBase):
        ...
        self.grp_filters.setStyleSheet("QgsCollapsibleGroupBoxBasic::title, QgsCollapsibleGroupBox::title { subcontrol-origin: margin; subcontrol-position: top left; margin-left: 20px; margin-right: 5px; left: 0px; top: 2px; }")
        self.grp_filters.setCollapsed(False)
        self.grp_filters.setScrollOnExpand(False)
        ...
        self.chk_auto_show = QtWidgets.QCheckBox(self.tab_search)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.chk_auto_show.sizePolicy().hasHeightForWidth())
        self.chk_auto_show.setSizePolicy(sizePolicy)
        self.chk_auto_show.setMinimumSize(QtCore.QSize(255, 30))
        self.chk_auto_show.setMaximumSize(QtCore.QSize(303, 30))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.chk_auto_show.setFont(font)
        self.chk_auto_show.setChecked(False)
        self.chk_auto_show.setObjectName("chk_auto_show")
        self.horizontalLayout_17.addWidget(self.chk_auto_show)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/search/caret-left.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/search/caret-right.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/settings/key.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_change_user.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/pencil.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/trash.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.mGroupBox.setStyleSheet("QgsCollapsibleGroupBoxBasic::title, QgsCollapsibleGroupBox::title { subcontrol-origin: margin; subcontrol-position: top left; margin-left: 20px; margin-right: 5px; left: 0px; top: 1px; } QgsCollapsibleGroupBoxBasic { border: none; }")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/settings/folder-open-o.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/settings/bullhorn.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/settings/question.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/settings/info.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/edit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_open_portalURL_config_dialog.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/settings/gear.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, IsogeoDockWidgetBase):
        ...
        self.lbl_inspire.setText(_translate("IsogeoDockWidgetBase", "INSPIRE themes"))
        ...
        self.chk_auto_show.setToolTip(_translate("IsogeoDockWidgetBase", "Display the results list"))
        self.chk_auto_show.setText(_translate("IsogeoDockWidgetBase", "Show result(s)"))
