...
class Ui_IsogeoDockWidgetBase(object):
    def setupUi(self, IsogeoDockWidgetBase):
        ...
        IsogeoDockWidgetBase.resize(595, 785)
        IsogeoDockWidgetBase.setMinimumSize(QtCore.QSize(595, 740))
        ...
        spacerItem12 = QtWidgets.QSpacerItem(128, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.txt_input.setMinimumSize(QtCore.QSize(275, 30))
        self.txt_input.setMaximumSize(QtCore.QSize(275, 30))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
