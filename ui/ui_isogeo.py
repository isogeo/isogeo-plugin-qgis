...
#
# Created: Fri Aug 10 17:31:03 2018
...
class Ui_IsogeoDockWidgetBase(object):
    def setupUi(self, IsogeoDockWidgetBase):
        ...
        self.btn_show.setMinimumSize(QtCore.QSize(201, 30))
        self.btn_show.setMaximumSize(QtCore.QSize(800, 30))
        icon1 = QtGui.QIcon()
        ...
        self.cbb_ob.setMinimumSize(QtCore.QSize(35, 0))
        self.cbb_ob.setMaximumSize(QtCore.QSize(50, 30))
        self.cbb_ob.setSizeAdjustPolicy(QtGui.QComboBox.AdjustToContents)
        ...
        self.cbb_od.setMinimumSize(QtCore.QSize(35, 0))
        ...
        self.cbb_od.setMinimumContentsLength(10)
        ...
        self.grp_filters.setMaximumSize(QtCore.QSize(800, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.grp_filters.setFont(font)
        self.grp_filters.setCollapsed(True)
