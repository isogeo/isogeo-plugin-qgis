...
class Ui_IsogeoDockWidgetBase(object):
    def setupUi(self, IsogeoDockWidgetBase):
        ...
        self.gridLayout_7.addWidget(self.groupBox_3, 7, 0, 1, 1)
        ...
        self.lineEdit_portal_url = QtWidgets.QLineEdit(self.groupBox_4)
        self.lineEdit_portal_url.setEnabled(False)
        self.lineEdit_portal_url.setObjectName("lineEdit_portal_url")
        self.horizontalLayout_7.addWidget(self.lineEdit_portal_url)
