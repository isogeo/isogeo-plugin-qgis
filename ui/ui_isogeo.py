...
class Ui_IsogeoDockWidgetBase(object):
    def setupUi(self, IsogeoDockWidgetBase):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/Isogeo/resources/search.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/Isogeo/resources/undo.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_reinit.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/Isogeo/resources/save.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.ico_license.setPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/Isogeo/resources/gavel.png")))
        ...
        self.tabWidget.addTab(self.tab_search, icon4, _fromUtf8(""))
        ...
        self.btn_default.setIcon(icon6)
        ...
        self.btn_reset_default.setIcon(icon5)
