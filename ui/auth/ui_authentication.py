...
class Ui_dlg_form_auth_prompt(object):
    def setupUi(self, dlg_form_auth_prompt):
        ...
        self.gridLayout_2.addWidget(self.lbl_api_url, 5, 3, 1, 1)
        ...
        self.btn_browse_credentials.setMinimumSize(QtCore.QSize(400, 30))
        self.btn_browse_credentials.setMaximumSize(QtCore.QSize(475, 30))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.gridLayout_2.addWidget(self.btn_browse_credentials, 0, 4, 1, 1)
        ...
        self.ent_app_secret.setMinimumSize(QtCore.QSize(400, 25))
        self.ent_app_secret.setMaximumSize(QtCore.QSize(400, 30))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.gridLayout_2.addWidget(self.ent_app_secret, 4, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_api_url_value, 5, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_browse_credentials, 0, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_app_id, 3, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_ok_cancel, 7, 0, 1, 8)
        ...
        self.ent_app_id.setMinimumSize(QtCore.QSize(400, 25))
        self.ent_app_id.setMaximumSize(QtCore.QSize(400, 30))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.gridLayout_2.addWidget(self.ent_app_id, 3, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_app_secret, 4, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.chb_isogeo_editor, 6, 4, 1, 1)
    ...
    def retranslateUi(self, dlg_form_auth_prompt):
        ...
        self.grb_connection_ready.setTitle(_translate("dlg_form_auth_prompt", "Plugin authentication to Isogeo API"))
