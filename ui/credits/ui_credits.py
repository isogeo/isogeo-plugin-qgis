...
class Ui_dlg_credits(object):
    def setupUi(self, dlg_credits):
        ...
        self.lbl_smavd_url.setText("<html><head/><body><p align=\"center\"><a href=\"https://www.smavd.org/\"><span style=\" text-decoration: underline; color:#0000ff;\">Syndicat Mixte d&apos;Am&eacute;nagement<br/>de la Durance (SMAVD)</span></a></p></body></html>")
        ...
        self.lbl_lorient_url.setText("<html><head/><body><p align=\"center\"><a href=\"https://www.lorient-agglo.bzh/\"><span style=\" text-decoration: underline; color:#0000ff;\">Communaut&eacute; d&apos;agglom&eacute;ration de<br/>Lorient (Lorient Agglom&eacute;ration)</span></a></p></body></html>")
        ...
        self.lbl_lorient_logo.setPixmap(QtGui.QPixmap(":/plugins/Isogeo/resources/credits/sponsor_logo_ca_lorient.png"))
        ...
        self.lbl_license_logo_gpl3.setText("<html><head/><body><p><a href=\"https://en.wikipedia.org/wiki/GNU_Lesser_General_Public_License\"><span style=\" text-decoration: underline; color:#0000ff;\">LGPL v3 - Wikipedia</span></a></p></body></html>")
        ...
        self.btn_ok_close.accepted.connect(dlg_credits.accept) # type: ignore
        self.btn_ok_close.rejected.connect(dlg_credits.reject) # type: ignore
    ...
    def retranslateUi(self, dlg_credits):
        ...
        self.lbl_isogeo_punchline.setText(_translate("dlg_credits", "<a href=\"https://www.isogeo.com\" style=\"color:#6480A7;text-decoration:none;\">Easy access to geodata!</a>"))
        ...
        self.lbl_source_repository.setText(_translate("dlg_credits", "<html><head/><body><p><a href=\"https://github.com/isogeo/isogeo-plugin-qgis\"><span style=\" text-decoration: underline; color:#0000ff;\">Code hosted on Github</span></a></p></body></html>"))
