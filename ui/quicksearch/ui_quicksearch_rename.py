...
class Ui_dlg_quicksearch_rename(object):
    def setupUi(self, dlg_quicksearch_rename):
        ...
        self.btn_save_cancel.accepted.connect(dlg_quicksearch_rename.accept) # type: ignore
        self.btn_save_cancel.rejected.connect(dlg_quicksearch_rename.reject) # type: ignore
