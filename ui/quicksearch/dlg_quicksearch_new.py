...
FORM_CLASS, _ = uic.loadUiType(os.path.join(os.path.dirname(__file__), "ui_quicksearch_new.ui"))

# from ui_quicksearch_new import Ui_Name
...
class QuicksearchNew(QDialog, FORM_CLASS):
    ...
    def __init__(self, parent=None):
        """Constructor."""
        super(QuicksearchNew, self).__init__(parent)
