...
FORM_CLASS, _ = uic.loadUiType(os.path.join(os.path.dirname(__file__), "ui_quicksearch_rename.ui"))

# from ui_quicksearch_rename import Ui_Rename
...
class QuicksearchRename(QDialog, FORM_CLASS):
    ...
    def __init__(self, parent=None):
        """Constructor."""
        super(QuicksearchRename, self).__init__(parent)
