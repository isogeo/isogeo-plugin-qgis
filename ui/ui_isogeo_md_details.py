...
#
# Created: Thu Aug 25 16:14:50 2016
...
class Ui_MetadataDetails(object):
    def setupUi(self, MetadataDetails):
        ...
        self.gridLayout_10 = QtGui.QGridLayout(MetadataDetails)
        ...
        self.gridLayout_10.addWidget(self.lbl_title, 0, 0, 1, 3)
        ...
        self.val_owner.setMaximumSize(QtCore.QSize(16777215, 25))
        ...
        self.val_keywords.setMaximumSize(QtCore.QSize(16777215, 25))
        ...
        self.val_inspire_themes.setMaximumSize(QtCore.QSize(16777215, 25))
        ...
        self.gridLayout_10.addWidget(self.grp_ident, 1, 0, 2, 2)
        ...
        self.gridLayout_5.addWidget(self.lbl_format, 0, 0, 1, 1)
        self.val_format = QtGui.QLineEdit(self.grp_technic)
        self.val_format.setReadOnly(True)
        self.val_format.setObjectName(_fromUtf8("val_format"))
        self.gridLayout_5.addWidget(self.val_format, 0, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.lbl_srs, 1, 0, 1, 1)
        self.val_srs = QtGui.QLineEdit(self.grp_technic)
        self.val_srs.setReadOnly(True)
        self.val_srs.setObjectName(_fromUtf8("val_srs"))
        self.gridLayout_5.addWidget(self.val_srs, 1, 1, 1, 1)
        self.gridLayout_10.addWidget(self.grp_technic, 1, 2, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.grp_contacts, 2, 2, 2, 1)
        ...
        self.gridLayout_4.addWidget(self.line_3, 0, 2, 3, 1)
        self.line_4 = QtGui.QFrame(self.grp_history)
        self.line_4.setFrameShape(QtGui.QFrame.VLine)
        self.line_4.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_4.setObjectName(_fromUtf8("line_4"))
        self.gridLayout_4.addWidget(self.line_4, 0, 5, 3, 1)
        ...
        self.gridLayout_4.addWidget(self.lbl_last_events, 0, 6, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lbl_data_crea, 1, 0, 1, 1)
        self.val_data_crea = QtGui.QLineEdit(self.grp_history)
        self.val_data_crea.setReadOnly(True)
        self.val_data_crea.setObjectName(_fromUtf8("val_data_crea"))
        self.gridLayout_4.addWidget(self.val_data_crea, 1, 1, 1, 1)
        self.lbl_valid_start = QtGui.QLabel(self.grp_history)
        self.lbl_valid_start.setObjectName(_fromUtf8("lbl_valid_start"))
        self.gridLayout_4.addWidget(self.lbl_valid_start, 1, 3, 1, 1)
        self.val_valid_start = QtGui.QLineEdit(self.grp_history)
        self.val_valid_start.setReadOnly(True)
        self.val_valid_start.setObjectName(_fromUtf8("val_valid_start"))
        self.gridLayout_4.addWidget(self.val_valid_start, 1, 4, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.list_events, 1, 6, 2, 2)
        self.lbl_data_updt = QtGui.QLabel(self.grp_history)
        self.lbl_data_updt.setObjectName(_fromUtf8("lbl_data_updt"))
        self.gridLayout_4.addWidget(self.lbl_data_updt, 2, 0, 1, 1)
        self.val_data_updt = QtGui.QLineEdit(self.grp_history)
        self.val_data_updt.setReadOnly(True)
        self.val_data_updt.setObjectName(_fromUtf8("val_data_updt"))
        self.gridLayout_4.addWidget(self.val_data_updt, 2, 1, 1, 1)
        self.lbl_valid_end = QtGui.QLabel(self.grp_history)
        self.lbl_valid_end.setObjectName(_fromUtf8("lbl_valid_end"))
        self.gridLayout_4.addWidget(self.lbl_valid_end, 2, 3, 1, 1)
        self.val_valid_end = QtGui.QLineEdit(self.grp_history)
        self.val_valid_end.setReadOnly(True)
        self.val_valid_end.setObjectName(_fromUtf8("val_valid_end"))
        self.gridLayout_4.addWidget(self.val_valid_end, 2, 4, 1, 1)
        self.gridLayout_10.addWidget(self.grp_history, 3, 0, 2, 2)
        ...
        self.gridLayout_10.addWidget(self.grp_fields, 4, 2, 3, 1)
        ...
        self.gridLayout_10.addWidget(self.groupBox, 5, 0, 1, 2)
        ...
        self.gridLayout_10.addWidget(self.grp_limitations, 6, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.grp_conditions, 6, 1, 1, 1)
        self.buttonBox = QtGui.QDialogButtonBox(MetadataDetails)
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName(_fromUtf8("buttonBox"))
        self.gridLayout_10.addWidget(self.buttonBox, 7, 2, 1, 1)
