...
class Ui_dlg_portal_base_url(object):
    def setupUi(self, dlg_portal_base_url):
        ...
        self.btn_save_cancel.accepted.connect(dlg_portal_base_url.accept) # type: ignore
        self.btn_save_cancel.rejected.connect(dlg_portal_base_url.reject) # type: ignore
