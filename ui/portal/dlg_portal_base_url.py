...
FORM_CLASS, _ = uic.loadUiType(os.path.join(os.path.dirname(__file__), "ui_portal_base_url.ui"))


# # changed besause of an issue generated by Qt Designer
# # see: http://gis.stackexchange.com/a/155599/19817
# class IsogeoPortalBaseUrl(QDialog, FORM_CLASS):
...
class IsogeoPortalBaseUrl(QDialog, FORM_CLASS):
    ...
    def __init__(self, parent=None):
        """Constructor."""
        super(IsogeoPortalBaseUrl, self).__init__(parent)
