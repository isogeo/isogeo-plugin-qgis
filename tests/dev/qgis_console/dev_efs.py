...
uri.setParam(
    "url", "http://geodata.nanterre.fr/arcgis/rest/services/Limite_Admin/MapServer/0"
)
...
qgis_efs_lyr_auto = QgsVectorLayer(
    uri.uri(), "URI - Nanterre AUTO", "arcgisfeatureserver"
)
